...
type ClassesInFutureClasses = Omit<IClasses, 'startsAt'>
interface IFutureClasses extends ClassesInFutureClasses{
	willStartsAt: string
}
...
interface IExClients extends ExClients {
	makeCallFor: Date
}

type FutureClients = Omit<IClients, 'timeLeft' | 'gender' | 'age'>

interface IFutureClients extends FutureClients{
	makeCallFor: Date
}
interface IFintessClub {
	clubName: string
	location: string
	classes: IClasses[]
...
const fitnessClubCenter: IFintessClub = {
